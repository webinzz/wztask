<x-layout>
    <main class="flex w-screen">
        ...
        <!-- Main Content -->
        <div class="relative  bg-[rgba(255,2555,255,1)] w-full h-[95vh] me-5 my-5 rounded-xl items-start p-5 px-8 overflow-y-scroll">
...
{{-- create --}}
<x-modal idmodal="create" width="26rem" title="create new task">
    <form class="p-4 md:p-5 flex flex-col gap-6" method="POST">
        @csrf
        <div>
