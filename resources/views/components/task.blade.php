...
<div class="relative col-span-1  shadow-sm p-5 rounded-lg min-h-72 flex justify-between flex-col overflow-hidden
...
">
    ...
    <div class="flex justify-between items-center z-10">
        ...
        <button id="doubleDropdownButton" data-dropdown-toggle="doubleDropdown{{ $task->id }}" data-dropdown-placement="right-start" type="button" class="bg-black opacity-75 w-10 h-10  rounded-full hover:scale-110">
